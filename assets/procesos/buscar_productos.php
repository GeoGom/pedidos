...
if (!empty($_SERVER['HTTP_X_REQUESTED_WITH']) && mb_strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
    ...
    $aplica_mayoreo = $_SESSION['cliente']['mayoreo'];
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                    <button type="button" 
                        ...
                        onclick="selectItems(
                                            '<?php echo $row['ID']; ?>',
                                            '<?php echo $row['ID_EXIST']; ?>',
                                            '<?php echo $row['ID_PRECIO']; ?>',
                                            '<?php echo $row['NOMBRE']; ?>',
                                            '<?php echo $row['PRECIOU']; ?>',
                                            '<?php echo $row['PRECIOP1']; ?>',
                                            '<?php echo $row['PRECIOP2']; ?>',
                                            '<?php echo $row['PRECIOF']; ?>',
                                            '<?php echo $row['MAYOREO']; ?>',
                                            '<?php echo $row['PRECIO_OFER']; ?>',
                                            '<?php echo $row['DESCUENTO']; ?>',
                                            '<?php echo $row['DESCUENTOPU']; ?>',
                                            '<?php echo $row['APLICADO']; ?>',
                                            '<?php echo $row['MED1']; ?>',
                                            '<?php echo $row['MED2']; ?>',
                                            '<?php echo $row['FRA1']; ?>',
                                            '<?php echo $row['FRA2']; ?>',
